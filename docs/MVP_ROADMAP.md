...
| **G2** | Versions pinned across repos, reproducibly | **Tooling done** — waiting on a green run to pin |
...
What remains is not code: **tag an MVP from a manifest generated by a fully
green run.** That is gated on G1.
